...
public class Datasource {
    ...
    public static final String CON_STR = "jdbc:sqlite:C:\\Users\\Joel\\Projects\\udemy\\Complete-Java-Masterclass\\Section 19\\Music\\" + DB_NAME;
    ...
    public static final String QUERY_SONG = "SELECT " + COL_SONG_ID + " FROM " + TABLE_SONGS + " WHERE " +
            COL_SONG_TITLE + " = ?";
