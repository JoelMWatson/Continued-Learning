...
//            buffer.put(outputBytes).putInt(245).putInt(-98765).put(outputBytes2).putInt(1000); // puts can be chained
//            buffer.flip();
            ...
            // Copy file with Random Access File
...
//            long numTransfered = copyChannel.transferFrom(channel, 0, channel.size());
            ...
            System.out.println("Number transfered: " + numTransfered);
...
//            System.out.println("inputString1 = " + new String(inputString));
...
//            buffer.flip();
//
//            int bytesWritten = binChannel.write(buffer);
//            System.out.println("Bytes Written: " + bytesWritten);
//
//            ByteBuffer intBuffer = ByteBuffer.allocate(Integer.BYTES);
//            intBuffer.putInt(245);
//            intBuffer.flip();
//            bytesWritten = binChannel.write(intBuffer);
//            System.out.println("Bytes Written: " + bytesWritten);
//
//            intBuffer.flip();
//            intBuffer.putInt(-98765);
