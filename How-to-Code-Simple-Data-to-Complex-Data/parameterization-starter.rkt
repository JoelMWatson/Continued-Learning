...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname parameterization-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; produce true if los includes n
(define (contains? n los)
  (cond [(empty? los) false]
        [else
         (if (string=? (first los) n)
             true
             (contains? n (rest los)))]))
